...
#' \dontrun{
#' Area <- data.frame(
#'   "name" = c("Aue", "Niederschlema", "Golzern"),
...
#'   ),
#'   "Northing_563790" = c(
#'     5608061.8, 5608061.8, 5608061.8, 5603061.8, 5603061.8,
#'     5603061.8, 5598061.8, 5598061.8, 5598061.8, 5593061.8, 5593061.8, 5593061.8
#'   ),
#'   "Easting_562040" = c(
#'     744830.4946, 749830.4946, 754830.4946, 749830.4946,
...
#'   ),
#'   "Easting_560020" = c(
#'     754830.4946, 754830.4946, 754830.4946, 754830.4946,
#'     759830.4946, 764830.4946, 759830.4946, 764830.4946, 759830.4946, 764830.4946,
#'     759830.4946, 764830.4946
#'   ),
#'   "Northing_560020" = c(
#'     5608061.8, 5603061.8, 5598061.8, 5593061.8, 5608061.8,
...
#' )
#' station_values <- data.frame(
#'   "00438" = runif(365, min = 0, max = 10),
...
#'
#' names(stations) <- c(
#'   "00438", "00559", "00840", "01153",
#'   "02038", "02372", "04506", "04767"
#' )
#' names(station_values) <- c(
#'   "00438", "00559", "00840",
#'   "01153", "02038", "02372", "04506", "04767"
#' )
#'
#' parameter <- "prec"
#'
#' interpolated_values <- voronoiinterpolation(
#'   Area, All_Days, YY, parameter, Station_list,
